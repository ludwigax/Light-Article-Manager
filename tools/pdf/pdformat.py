...
if __name__ == "__main__":
    pdf_path = "2007.01282v2.pdf"
    formattor = Formattor(pdf_path, output_name=osp.join("new_test_work_list", pdf_path.replace(".pdf", ".txt")))
    formattor.extract_pages()
    formattor.analyze_pages()
    text = formattor.text(save=True, no_ref=True)
    formattor.close()