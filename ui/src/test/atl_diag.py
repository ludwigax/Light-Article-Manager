...
"}")
        ...
        self.textedit_title = QPlainTextEdit(self.widget)
...
"}")
        ...
        self.textedit_author = QPlainTextEdit(self.widget_2)
...
"}")
        ...
        self.textedit_journal = QPlainTextEdit(self.widget_3)
...
"}")
        ...
        self.textedit_year = QPlainTextEdit(self.widget_4)
...
"}")
        ...
        self.textedit_doi = QPlainTextEdit(self.widget_5)
