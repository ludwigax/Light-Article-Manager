...
def on_new_article_archi(clf, title, idx1):
...
def on_remove_article_archi(clf, title, idx1, idx2):
    archi = Archi()
    archi.load()
    opn.delete_folder_article(archi, title, idx1, idx2)
    archi.save()

def on_new_folder_archi(clf, title, idx1):
    archi = Archi()
    archi.load()
...
def on_rename_folder_archi(clf, title, idx1):
    archi = Archi()
    archi.load()
...
def on_delete_folder_archi(clf, title, idx1):
    archi = Archi()
    archi.load()
